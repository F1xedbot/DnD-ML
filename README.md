...
| [**Terrain Labeling**](src/terrain_labeling) | Uses CLIP and depth models to analyze top-down battlemaps, label terrain types, and estimate walkable areas. Outputs a structured grid for further use. |
